...
public class TerrainChunk {
  ...
  private Color[] baseColors = new Color[] { Color.blue, new Color(194/255f, 178/255f, 128/255f), Color.green };
  private float[] baseStartHeights = new float[] { 0, 0.274f, 0.294f };
  ...
  public TerrainChunk(Vector2 coord, int size, Transform parent) {
    ...
    MapManager.RequestMapInfo(mapData => {
      ...
      meshRenderer.material.SetFloatArray("baseStartHeights", baseStartHeights);
    });
