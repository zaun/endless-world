...
namespace MenteBacata.ScivoloCharacterController
{
    ...
    public partial class CharacterMover : MonoBehaviour
    {
        ...
        /// <summary>
        /// Maximum possible number of contacts that can be detected, useful for instantiating the contact list without the need for 
        /// further resizing.
        /// </summary>
        public static int MaxContactsCount => maxMoveLoopIterations + maxStepDownLoopIterations;
